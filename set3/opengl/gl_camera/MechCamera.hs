...
mechWindowTitle = "OctaneMech Camera Demo"
mechScreenWidth = 640
mechScreenHeight = 480
mechZPerspective = 100.0
...
mechLaunchGLWindow = do
  ...
  angleRotRef <- newIORef 0
            
  -- Set the OpenGL callbacks
  displayCallback $= displayGameLoop mainCameraRef mainMechRef angleRotRef

  -- Set the keyboard callback for handling actions
  keyboardMouseCallback $= Just (mechKeyPressed)
